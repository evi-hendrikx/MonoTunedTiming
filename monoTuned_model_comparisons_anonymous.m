...
if find(strcmp(modelFieldNames,'TunedLin2d'))
    ...
    if sum(stat.normality_jb.adj_pnorm<.05)>0
        for roi = 1:length(ROIs)
            [stat.wilcoxon.(ROIs{roi}).p, stat.wilcoxon.(ROIs{roi}).h, stat.wilcoxon.(ROIs{roi}).stats] = signrank(stat.data.(ROIs{roi}).(modelFieldNames{1}), stat.data.(ROIs{roi}).(modelFieldNames{2}));
    ...
    signif_0001 = repelem(NaN, length(ROIs));
    ...
    for plot_kind = 1:length(plots)
        ...
        if plot_kind == 1
            ...
            scatter(x_LR,midpoints_mod1(1,scatter_order),24,'s','MarkerFaceColor',mod1_bar,'MarkerEdgeColor','k', 'HandleVisibility', 'off');
            scatter(x_LR,midpoints_mod2(1,scatter_order),20,'d','MarkerFaceColor',mod2_bar,'MarkerEdgeColor','k', 'HandleVisibility', 'off');
        ...
        elseif plot_kind == 2
            ...
            % redraw markers on top (otherwised covered by error bars)
            scatter(x_LR,midpoints_diff(1,scatter_order),24,'o','MarkerFaceColor',diff_bar,'MarkerEdgeColor','k', 'HandleVisibility', 'off');
            
        end
        
        % create significance markers
        scatter(x_LR,signif_0001(1,(scatter_order)),24,'*','k', 'HandleVisibility', 'off');
...
%% compare two monotonic models
    ...
    %% plots: significance markers
    signif_0001 = NaN; signif_001 = NaN; signif_01 = NaN; signif_05 = NaN;
    sig = 0.32;
    ...
    % redraw markers on top (otherwised covered by error bars
    scatter(1,midpoints_mod1,24,'s','MarkerFaceColor',mod1_bar,'MarkerEdgeColor','k', 'HandleVisibility', 'off');
    scatter(2,midpoints_mod2,20,'d','MarkerFaceColor',mod2_bar,'MarkerEdgeColor','k', 'HandleVisibility', 'off');
    
    % create significance markers
    scatter(1.5,signif_0001,24,'*','k', 'HandleVisibility', 'off');
